# =============================================================================
# Development Environment - OCI OKE
# =============================================================================
...
module "vcn" {
  ...
  subnet_count   = 2 # Dev uses 2 subnets
...
module "oke" {
  ...
  cluster_type       = "BASIC_CLUSTER" # Basic for dev

  cni_type           = "FLANNEL_OVERLAY" # Flannel for simplicity in dev
